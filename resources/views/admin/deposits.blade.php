        ...
        <div class="container-fluid card">
            <div class="row m-t-25 justify-content-between">
                <div class="col-lg-12">
                    ...
                    <a href="/admin/deposit/new" class="btn btn-info" style="float:right"> New Deposit</a>
                    <p>Summary of your deposits.</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                 ...
                                                 @foreach($deposits->pending as $deposit)	
                                                            ...
                                                            <div class="fright" style="float:right"> <a href="/admin/deposit/confirm/{{$deposit['id']}}"><button class="btn btn-success"> Confirm  </button> </a> </div>
                                                            <h4> <span class="fa fa-user-circle"> <strong>{{$deposit->user}}  </strong></span>    </h4>
                                                            <p> 
                                                            <b>Amount: </b> {{ $deposit->amount}}   {{$deposit->asset_data->short}}<br />
                                                            <b>Comment: </b> {{$deposit->comment}} <br />
                                                             
                                                            Added On:{{get_date($deposit->updated_at)}}
                                                           <hr /> </div>
                                                @endforeach
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                @foreach($deposits->confirmed as $deposit)	
                                                      ...
                                                      <h4> <span class="fa fa-user-circle"> <strong>{{$deposit->user}}  </strong></span>    </h4>
                                                            ...
                                                            <b>Amount: </b> {{ $deposit->amount}}   {{$deposit->asset_data->short}}<br />
                                                            <b>Comment: </b> {{$deposit->comment}} <br />
                                                             On:{{get_date($deposit->updated_at)}} <br>
                                                            Status:Confirmed.
                                                           <hr /> </div> 
