...
<body>
    ...
    <div class="header">
        ...
        <div class="navbar-custom-menu pull-right d-flex nav-right">
            <div class="dropdown">
                ...
                <div class="dropdown-menu inbox-dropdown  dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                    <div class="message-options">
                        <a href="#" class="single-message">Message</a>
                        <a href="#" class="view-all-message pull-right">View All</a>
                        <a href="#" class="compose-message pull-right">Compose</a>
                    </div>
                    </div>
            </div>
            <div class="dropdown">
            ...
            <div class="dropdown">
                <a class="dropdown-toggle user-profile-dropdown" href="#" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="user-img">
                        <img src="/gallery/{{$user->photo}}" alt="avatar" style="width:20px; height:20px;">
                    </span>
    ...
    <div class="nk-sidebar">
        <div class="nk-nav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a class="has-arrow" href="/trade/new" aria-expanded="false">
                        <i class="fa fa-exchange"></i>
                        <span class="nav-text">Create Trade</span>
                    </a>
                  ...
                  <li>
                    <a class="" href="/trades" aria-expanded="false">
                        <i class="fa fa-exchange"></i>
                        <span class="nav-text">Trading Room</span>
                        <ul aria-expanded="false">
                        <li>
                            <a href="/trades">View Rooms</a>
                        </li>
                        <li>
                            <a href="/trade/join">Join Room</a>
                        </li>
                ...
                <li>
                    <a href="/transactions" aria-expanded="false">
                    <i class="fa fa-bitcoin"></i>
                        <span class="nav-text">Account Transactions</span>
                    </a>
                </li>  
                <li>
    ...
    <script>
                ...
                function assetGo(){
                    var assetAmount=$('#asset').val();
                    var rate=$('#rate').val();
                   // alert(rate);
                    var feeRate=$('#feeRate').val();
                    var assetTwoAmount=assetAmount*rate;
                    var fee=assetTwoAmount*feeRate;
                    $('#asset_two').val(assetTwoAmount);
                    $('#fee').html(fee);
                }

                function getbal(){
                    var asset=$('#availAsset').val();
                           var bal=0; 
                         var url="http://localhost:8000/api/wallet/"+asset;
                        // alert(url);
        ...
        async: false
                             ...
                             // bal=JSON.parse(JSON.stringify(data));
                            
                             // setVal(localStorage.bal=bal['balance']);
                ...
                function avail(){
                    ...
                    var amount=$('#availAmount').val();
                 
                    
                    $.get(url, function(data, status){
                        var but=$('#availBut');
                             var bal=JSON.parse(JSON.stringify(data));
                    ...
                    if(balance>0){
                               ...
                               // but.attr('disabled', true);
                                    live='<div class="alert alert-danger"> Balance too low for entered amount Please <a href="/deposit">Deposit </a> to your wallet to continue   </div>';
                                ...
                                live='<div class="alert alert-danger"> Please <a href="/deposit">Deposit </a> to your wallet to continue   </div>';
                                }
